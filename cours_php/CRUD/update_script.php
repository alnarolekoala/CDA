...
try{ 
        ...
        $requete = $db->prepare("UPDATE disc SET disc_title=:title, disc_year=:annee, disc_genre=:genre, disc_label=:label, disc_price=:price, disc_picture=:picture, artist_id=:artist_id WHERE disc_id=".$disc_id);
...
exit;
         ...
         header("Location: update_form.php?disc_id=$disc_id&title=$title&annee=$annee&genre=$genre&label=$label&price=$price&picture=$picture&erreur0=$erreur0&erreur1=$erreur1&erreur2=$erreur2&erreur3=$erreur3&erreur4=$erreur4&erreur5=$erreur5");
}
